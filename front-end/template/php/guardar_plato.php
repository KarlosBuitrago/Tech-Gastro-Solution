...
$file_urls = array();
$image_base_url = BACKEND_URL . '/images/dishes/';
...
if (isset($_FILES['img'])) {
    ...
    for ($i = 0; $i < $all_files; $i++) {
        ...
        $file_ext = strtolower(pathinfo($_FILES['img']['name'][$i], PATHINFO_EXTENSION));
...
curl_setopt($curl, CURLOPT_URL, api_url('/gastro-tech/api/v1/dishes/dish'));
